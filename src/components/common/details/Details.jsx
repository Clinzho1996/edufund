...
const Details = () => (
  <main>
    ...
    <Container className="about-main our-types-future" id="about" style={{marginBottom: 100}}>
        <Row>
            <Col xs="6">
            <Card style={{ width: "100%" }} className="shadow p-0 mb-2 bg-body rounded type-card">
              <Card.Body>
              ...
              <Card.Title
                ...
                <Card.Subtitle className="subtitle">
                    <h4 style={{color: '#3180EB', fontWeight: 600}}>Basic Information</h4>
                ...
                <div className="amount-raised">
                  <p><span style={{color: '#3180EB', fontWeight: 600}}>Raised: </span>$300,000</p>
                  <p><span style={{color: '#3180EB', fontWeight: 600}}>Supporters: </span> 35</p>
                  <p><span style={{color: '#3180EB', fontWeight: 600}}>Target: </span> $600</p>
                </div>
                <Form>
                  <div className="custom-amount">
                ...
                <br /> 
                <h4 style={{color: '#3180EB', fontWeight: 600}}>Social Media</h4>
