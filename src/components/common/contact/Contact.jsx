            ...
            <Row className="cont">
                <Col xs="4">
                    ...
                    <div className="appointment">
                        ...
                        <h6>Our global presence ensures the responsiveness and cost efficiency compliance required to meet your production deadlines.</h6>
                        <br />
                ...
                <Col xs="8 shadow p-3 mb-5 bg-body rounded" className="contact" id="contact">
                <Form>
                    ...
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        ...
                        <Form.Control type="email" placeholder="Enter your email address here..." />
                    </Form.Group>
