      ...
      <Row>
        <Col xs="6">
          ...
          <h2>
            ...
            consectetur adipisicing elit. Ipsa, minima?
          </h2>
          <h5>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quis, sint
            quod temporibus architecto totam voluptatum ducimus? Ratione,
            officia sapiente! Facere harum nobis nam minus ut voluptate illum
            dignissimos architecto sed.
          </h5>
    ...
    <Container className="abt-sec">
      <center>
        ...
        <h5>
          ...
          dolore qui laboriosam est eius dolor accusantium esse laborum quia
          adipisci inventore itaque. Maiores incidunt, explicabo dolores
          voluptatibus excepturi esse.
        </h5>
      </center>
    </Container>
      ...
      <Row>
        <Col xs="4" className="abt-info">
          ...
          <p>
            ...
            Voluptatibus odit et inventore hic vitae! Molestias repellendus
            aliquid itaque soluta. Necessitatibus.
          </p>
        </Col>
        <Col xs="4" className="abt-info">
        ...
        <Col xs="4" className="abt-right">
          <h2>
            ...
            tempore aliquam laborum dolor accusantium illo quam reiciendis ea
            incidunt facere.
          </h2>
        </Col>
      </Row>
