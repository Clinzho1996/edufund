      ...
      <Container>
        <Row>
          <Col xs="6" className="mainLeft">
            <h2>
              Learning should be{" "}
              <span style={{ color: "#2B53AE" }}>easy and accessible</span> for
              all
            </h2>
            <p>
              At Edufund we create equal opportunity for passionate learners to
              learn and earn with digital skills
            </p>
      ...
      <Container className="clients">
        <Row>
          ...
          <Col lg="2" md="3" sm="4" xs="6">
            <h3 className=" d-flex align-items-center gap-1">
              {" "}
              <i className="fa fa-search"></i> Finder
            </h3>
          </Col>
            ...
            >
              <Card.Body>
                ...
                <Card.Subtitle className="subtitle">
                  My name is Femi. i'm interested in learning Django framework
                  for backend development. I saw a course online with a lot of
                  rating on Udemy
                  <br /> <br />
                  <ProgressBar now={60} />
                  <Form>
